...
import com.youtube.dao2.SchemaQuery;
import com.youtube.util.ToJSON_post;
...
public class V3_inventory {
	...
	public Response addPcParts2(String incomingData) throws Exception {
		...
		SchemaQuery dao = new SchemaQuery();
		...
		try {
			 ...
			 */
			ToJSON_post converter = new ToJSON_post();
//			incomingData = converter.toJSONArray(incomingData);
			
			JSONArray jsonArr = converter.toJSONArray(incomingData);
//			JSONObject partsData = new JSONObject(incomingData);
			JSONObject partsData = jsonArr.getJSONObject(0);
			 ...
			 * exist.
			 */
			int http_code = dao.insertIntoPC_PARTS(partsData.optString("ID"), 
